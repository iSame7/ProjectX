...
extension MapViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let viewData = CollectionViewCell.CollectionViewData(image: venuePhotos[venue.id], title: venue.name, categoryName: venue.categories.first?.name ?? "", description: String(distanceMi) + " mi " + (venue.location.address ?? ""))
